          ...
          <Card key={q._id} className="bg-gray-900 text-white">
            <CardContent className="p-5">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-lg font-bold hover:underline cursor-pointer">{q.title}</h3>
                  <p className="text-sm text-gray-300 mt-2 line-clamp-2">{q.body}</p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-400">Answers: {q?.answers?.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
